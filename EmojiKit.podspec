...
Pod::Spec.new do |s|
  s.name             = "EmojiKit"
  s.version          = "0.1.0"
  s.summary          = "A short description of EmojiKit."
  s.description      = <<-DESC
                       An optional longer description of EmojiKit
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/EmojiKit.git", :tag => s.version.to_s }
